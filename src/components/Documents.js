...
function Documents () {
    ...
    return (
        <section id="documents" className="pt-5 pb-5" style={{width:"100%"}}> 
            <h1 className="display-5 font-weight-bold text-center pb-5" style={{color: "#228B22"}}>DOCUMENTS À FOURNIR</h1>
            <div class="row" style={{marginLeft:"-2px", marginRight:"-2px"}}>
            <div class="col-sm-4">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title text-center font-weight-bold pt-2" style={{color: "#808080"}}>La carte grise du véhicule</h4>
            ...
            <div class="col-sm-4">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title text-center font-weight-bold pt-2" style={{color: "#808080"}}>Un certificat de non gage</h4>
            ...
            <div class="col-sm-4">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title text-center font-weight-bold pt-2" style={{color: "#808080"}}>Une pièce d’identité valide</h4>
