...
function How () {
    ...
    return (
        <section id="how" className="pt-5 pb-5" style={{backgroundColor: "#E5E4E2", width:"100%"}}> 
                <h1 className="display-5 font-weight-bold text-center pb-5" style={{color: "#228B22"}}>COMMENT ÇA MARCHE</h1>
            <div className="card-deck" style={{marginLeft:"-2px", marginRight:"-2px"}}>
                <div className="card">
                    <img src={appointment} className="card-img-top" alt="..." />
                    <div className="card-body">
                    <h4 className="card-title font-weight-bold text-center"> Etape 1 : Prendre RDV</h4>
                ...
                <div className="card">
                    ...
                    <div className="card-body">
                    <h4 className="card-title font-weight-bold pt-0 text-center" >Etape 2: Retrait</h4>
                ...
                <div className="card">
                    ...
                    <div className="card-body">
                    <h4 className="card-title font-weight-bold text-center" >Etape 3: Recyclage</h4>
