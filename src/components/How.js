...
function How () {
    ...
    return (
        ...
        <section id="how" className="pt-5 pb-5" style={{backgroundColor: "#228B22", width:"100%"}}> 
                <h1 className="display-4 font-weight-bold text-white text-center pb-5">COMMENT ÇA MARCHE</h1>
            <div className="card-deck" style={{marginLeft:"-2px", marginRight:"-2px"}}>
                <div className="card">
                    <img src={appointment} className="card-img-top" alt="..." />
                    <div className="card-body">
                    <h3 className="card-title font-weight-bold text-center" style={{fontFamily:"DejaVu Sans Mono, monospace"}}>Etape 1 : Prendre RDV</h3>
                ...
                <div className="card">
                    ...
                    <div className="card-body">
                    <h3 className="card-title font-weight-bold pt-0 text-center" style={{fontFamily:"DejaVu Sans Mono, monospace"}}>Etape 2: Retrait</h3>
                ...
                <div className="card">
                    ...
                    <div className="card-body">
                    <h3 className="card-title font-weight-bold text-center" style={{fontFamily:"DejaVu Sans Mono, monospace"}}>Etape 3: Recyclage</h3>
